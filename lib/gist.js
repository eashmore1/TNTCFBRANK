/* ============================================================
   ...
   Two things to know. Reads go through api.github.com, which allows 5,000
   authenticated requests an hour — plenty here, and store.js's read cache
   keeps concurrent viewers from each spending one. And every save writes a
   gist revision, so the gist's history grows one entry per ballot change,
   which is harmless but will look busy if you go and read it.
   ============================================================ */
